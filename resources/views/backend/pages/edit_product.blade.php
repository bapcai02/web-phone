                            ...
                            @foreach($product as $pro)
                                <form action="{{route('update_product',['id'=>$pro->id])}}" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{URL::to('/backend/images/product/'.$pro->image1)}}" width="100px" height="100px">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Hình Ảnh 2</label>
                                        <input type="file" name = "image2">
                                        <img src="{{URL::to('/backend/images/product/'.$pro->image2)}}" width="100px" height="100px">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Hình Ảnh 3</label>
                                        <input type="file" name = "image3">
                                        <img src="{{URL::to('/backend/images/product/'.$pro->image3)}}" width="100px" height="100px">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$pro->total_quantity}}" type="text" class="form-control" name="price_promotion" placeholder="Enter name">
                                    </div>
                                    <div class="form-group">
