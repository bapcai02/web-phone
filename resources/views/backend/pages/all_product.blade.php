      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td> <img src="bapcai/img/product/{{$data->image1}}" style="width:50px;height:50px"></td>
            <td> <img src="bapcai/img/product/{{$data->image2}}" style="width:50px;height:50px"></td>
            <td> <img src="bapcai/img/product/{{$data->image3}}" style="width:50px;height:50px"></td>
            <td>{{$data->size_id}}</td>
