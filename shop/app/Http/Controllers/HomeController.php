...
class HomeController extends Controller
{
    ...
    public function index(){
        ...
        $product_watch = DB::table('product')->where('category_id','9')->orderBy('price_promotion','desc')->limit(4)->get();
        $product_accessories = DB::table('product')->where('category_id','5')->orderBy('price_promotion','desc')->limit(4)->get();
